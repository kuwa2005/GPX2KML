...
- `og-image.png` - OGP / SNS 用サムネイル（1200×630）
- `scripts/build_ogp_image.py` - 上記サムネイルの再生成スクリプト（要 Pillow）
- `README.md` - 本ドキュメント
- `SECURITY.md` - セキュリティ方針・レビュー記録
...
- 方針・レビュー履歴・既知の制約は [SECURITY.md](./SECURITY.md) を参照してください。
- GPX はブラウザ内のみで処理され、サーバへアップロードされません。
